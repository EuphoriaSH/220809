...
contract KIP17TokenOwnable is KIP17Full, KIP17MintableOwnable, KIP17MetadataMintableOwnable, KIP17Burnable, KIP17Pausable {
    ...
    function updateMyNftList (address owner) public view returns(myNftInfo[] memory){
        ...
        //k = MintIndex[j]; k <MintIndex[j]+MintIndex[j+1]; k ++
...
//     판매 컨트랙트 시작
    ...
    // function salesStand (string memory tokenURI, uint _salesNumberOfNFT, uint _priceOfNFT) public returns (bool) {

    // }

    // function buyStand () public 




}
    // File contracts/token/KIP17/KIP17TokenOwnable.